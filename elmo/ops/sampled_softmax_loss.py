...
class SampledSoftmaxLoss(_Loss):
    ...
    def construct(self, weights, biases, labels, inputs, sampled_value=None):
    ...
    def _compute_sampled_logits(self, weights,
        ...
        sampled_w = self.cast(sampled_w, mindspore.float16)
        ...
        true_logits = self.cast(true_logits, mindspore.float32)
        sampled_logits = self.cast(sampled_logits, mindspore.float32)
